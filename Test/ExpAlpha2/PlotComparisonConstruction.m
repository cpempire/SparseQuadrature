...
legend('priori \fontsize{16}GH1','priori \fontsize{16}GH2','priori \fontsize{16}tGKP',...
       ...
       'posteriori \fontsize{16}GK','\fontsize{16}N^{-2}', 'Location','SouthWest')

xlabel('# points', 'FontSize',16,'Interpreter','latex')
ylabel('$|I(f) - \mathcal{Q}_{\Lambda}(f)|$','FontSize',16,'Interpreter','latex')
set(gca,'FontSize',16)
saveas(gcf,'OldPointsPrioriPosterioriAlpha2.eps','epsc')
%% 
figure
...
ylabel('$|I(f) - \mathcal{Q}_{\Lambda}(f)|$','FontSize',16,'Interpreter','latex')
set(gca,'FontSize',16)
saveas(gcf,'OldIndicesPrioriPosterioriAlpha2.eps','epsc')
%% 
figure
load QuadExpAlpha2
test_value = exp(sum((1:10000).^(-4))/2);
...
axis([1,1e4,0,6])
set(gca,'FontSize',16)
saveas(gca,'GH1GH2LevelAlpha2.eps','epsc')
...
saveas(gca,'tGKPGKLevelAlpha2.eps','epsc')
...
% axis([1,1e4,0,25])
% set(gca,'FontSize',16)
% saveas(gcf,'GH1LevelAlpha2.eps','epsc')
% 
% figure
% load QuadExpAlpha2Priori
% subplot(2,1,1)
...
% axis([1,1e4,0,6])
% set(gca,'FontSize',16)
% saveas(gcf,'GH2LevelAlpha2.eps','epsc')
% 
% figure
% load QuadExpAlpha2Priori
% subplot(2,1,1)
...
% axis([1,1e4,0,6])
% set(gca,'FontSize',16)
% saveas(gcf,'tGKPLevelAlpha2.eps','epsc')
% 
% figure
% load QuadExpAlpha2Priori
% subplot(2,1,1)
...
% axis([1,1e4,0,4])
% set(gca,'FontSize',16)
% saveas(gcf,'GKLevelAlpha2.eps','epsc')