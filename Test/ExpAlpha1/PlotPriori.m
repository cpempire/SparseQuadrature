...
legend('\alpha = 1 \fontsize{16}GH1','\alpha = 1 \fontsize{16}GH2','\alpha = 1 \fontsize{16}tGKP',...
       '\alpha = 1 \fontsize{16}GK','\alpha = 1 \fontsize{16}MC','\fontsize{16}N^{-1/2}', ...
       '\alpha = 2 \fontsize{16}GH1','\alpha = 2 \fontsize{16}GH2','\alpha = 2 \fontsize{16}tGKP',...
       '\alpha = 2 \fontsize{16}GK','\alpha = 2 \fontsize{16}MC','\fontsize{16}N^{-3/2}')
xlabel('# points', 'FontSize',16,'Interpreter','latex')
ylabel('$|I(f) - \mathcal{Q}_{\Lambda}(f)|$','FontSize',16,'Interpreter','latex')
set(gca,'FontSize',16)
saveas(gcf,'OldPointsPriori.eps','epsc')
%%
load QuadExpAlpha1Priori
test_value = exp(sum((1:10000).^(-2))/2);
...
legend('\alpha = 1 \fontsize{16}GH1','\alpha = 1 \fontsize{16}GH2','\alpha = 1 \fontsize{16}tGKP',...
       '\alpha = 1 \fontsize{16}GK','\fontsize{16}N^{-1/2}', ...
       '\alpha = 2 \fontsize{16}GH1','\alpha = 2 \fontsize{16}GH2','\alpha = 2 \fontsize{16}tGKP',...
       '\alpha = 2 \fontsize{16}GK','\fontsize{16}N^{-2}')
xlabel('# indices', 'FontSize',16,'Interpreter','latex')
ylabel('$|I(f) - \mathcal{Q}_{\Lambda}(f)|$','FontSize',16,'Interpreter','latex')
set(gca,'FontSize',16)
saveas(gcf,'OldIndicesPriori.eps','epsc')
%% 
load QuadExpAlpha1Priori
test_value = exp(sum((1:10000).^(-2))/2);
...
set(gca,'FontSize',16)
saveas(gcf,'AllPointsPriori.eps','epsc')
%%
load QuadExpAlpha1Priori
test_value = exp(sum((1:10000).^(-2))/2);
...
ylabel('$|I(f) - \mathcal{Q}_{\bar{\Lambda}}(f)|$','FontSize',16,'Interpreter','latex')
set(gca,'FontSize',16)
saveas(gcf,'AllIndicesPriori.eps','epsc')
%%
load QuadExpAlpha2Priori
...
ylabel('level')
set(gca,'FontSize',16)
saveas(gcf,'tGKPPriori.eps','epsc')
