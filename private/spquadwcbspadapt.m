function w = spquadwcbspadapt(seq,w1d,id,fromindex,toindex)
% SPQUADWCBSPADAPT  Compute quadrature weights, Chebyshev grid 
%    W = SPQUADWCBSP(LEVELSEQ)  Computes the quadrature weights
%    for the given sequence of index sets LEVELSEQ with indices 
%    between fromindex and toindex. One row of 
